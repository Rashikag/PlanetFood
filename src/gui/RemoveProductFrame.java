...
private String catId;
    ...
    private void initComponents() {
        ...
        btnRemProduct.setBackground(new java.awt.Color(0, 153, 153));
        btnRemProduct.setForeground(new java.awt.Color(255, 255, 255));
        btnRemProduct.setText("Remove Product");
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        .addGap(12, 12, 12)
                        .addComponent(btnRemProduct, javax.swing.GroupLayout.DEFAULT_SIZE, 126, Short.MAX_VALUE))
    ...
    private void comboCategoryActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_comboCategoryActionPerformed
        ...
        try{
          ...
          if(comboCategory.getSelectedItem()==null)
              return;
        catName=(String)comboCategory.getSelectedItem();
           
        catId=(String)category.get(catName);
    ...
    private void btnRemProductActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRemProductActionPerformed
        // TODO add your handling code here:
        if(validateInput()==false)
        {
           JOptionPane.showMessageDialog(null,"There are no products available for this category"," Exception!",JOptionPane.INFORMATION_MESSAGE);
        ...
        {  Product p=new Product();
           // String catname=(String)comboCategory.getSelectedItem();
            ...
            String prodid=(String)productList.get(prodName);
           ...
           int x=comboProduct.getSelectedIndex();
           comboProduct.removeItemAt(x);
           }
         else
